...
export function createDemoState(): AppState {
  ...
  return {
    ...
    investments: [
      { id: nextId('inv'), name: 'Tesouro Selic', value: 12000, cls: 'renda fixa', ret: '+0,9%/mês', good: true, color: '#10B981' },
      { id: nextId('inv'), name: 'CDB 108% CDI', value: 9500, cls: 'renda fixa', ret: '+1,0%/mês', good: true, color: '#34D399' },
      { id: nextId('inv'), name: 'Ações', value: 7200, cls: 'renda variável', ret: '↑ +4,2%', good: true, color: '#FBBF24' },
      { id: nextId('inv'), name: 'Fundos imobiliários', value: 4300, cls: 'FIIs', ret: '+0,7%/mês', good: true, color: '#34D399' },
